...
<div id= "content">
<?php echo form_open("company_insert/do_insert_vacancy"); ?>
...
<div>
	<h2>Qualifications</h2>
		...
		<div id="data_row">
			<label id="data_label">Gender </label>
			<div id="data_input"><input type="radio" name="gender" value="male"/>Male
								<input type="radio" name="gender" value="female"  style="margin-left:15px;"/>Female
								<input type="radio" name="gender" value="both"  style="margin-left:15px;"/>Both
			</div>
			<br/>
		</div>
		<div id="data_row">
			<label id="data_label">Age Group</label>
			<div id="data_input"><label style="margin-right:50px">From</label> 
			<select name="age1">
			...
			<label style="margin-right:69px">To</label>  
			<select name="age2">
					<option>Select Age</option>
					<?php for($i=18; $i<=85; $i++) { ?>
						<option><?php echo $i; ?> </option> 
		...
		<br/>
		<div id="data_row">
			<label id="data_label">Preffered District</label>
